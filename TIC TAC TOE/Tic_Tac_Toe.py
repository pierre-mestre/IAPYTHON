...
def checkIfFinish():
    ...
    if checkPosition(1) == True :
        finish = True
        winner = 1
    if  checkPosition(2) == True :
        finish = True
        winner = 2
    liste.clear()

def checkPosition(idplayer):        
    if liste[4]!=0:
        if liste[4]==idplayer and liste[0] == idplayer and liste[8] == idplayer:
            return True
        if liste[4]==idplayer and liste[1] == idplayer and liste[7] == idplayer:
            return True
        if liste[4]==idplayer and liste[2] == idplayer and liste[6] == idplayer:
            return True
        if liste[4]==idplayer and liste[3] == idplayer and liste[5] == idplayer:
            return True
    if liste[0]!=0:
        if liste[0]==idplayer and liste[1] == idplayer and liste[2] == idplayer:
            return True
        if liste[0]==idplayer and liste[3] == idplayer and liste[6] == idplayer:
            return True
    if liste[8]!=0:
        if liste[8]==idplayer and liste[7] == idplayer and liste[6] == idplayer:
            return True
        if liste[8]==idplayer and liste[5] == idplayer and liste[2] == idplayer:
            return True
    else:
        return False
